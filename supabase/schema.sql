...
-- IMPORTANTE: con estas politicas, cualquier usuario autenticado ve todo. Como
-- la llave publishable es publica, lo unico que impide que un extrano se cree
-- una cuenta y lea el historial es tener el auto-registro APAGADO en
-- Authentication -> Sign In / Providers -> Email -> "Allow new users to sign up".
--
-- Para agregar una segunda linea de defensa mas adelante, descomentar esta
-- funcion y cambiar cada `true` de abajo por `public.is_firm_member()`:
--
